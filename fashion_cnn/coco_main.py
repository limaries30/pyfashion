...
print('model_dir:',FASHION_MODEL_PATH)
print('log_dir:',DEFAULT_LOGS_DIR)
...
class FashionDataset(utils.Dataset):
    def load_coco(self, json_file_dir, image_dir,class_ids=None,
                  class_map=None, return_coco=False, auto_download=False):
        """Load a subset of the COCO dataset.
        
        json_file_dir: /path/to/deepfahsion2.json
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir',
                        metavar="/path/to/train_image/",default="C:/tensor_code/fashion/dataset/deepfashion2/train/0", 
                        help='Directory of the MS-COCO dataset')
    ...
    if args.command == "train":
        ...
        dataset_train.load_coco(json_file_dir=args.json_file_dir,image_dir=args.image_dir)
        dataset_train.prepare()

        # Validation dataset
        dataset_val = FashionDataset()
        #val_type = "val" if args.year in '2017' else "minival"
        dataset_val.load_coco(json_file_dir=args.val_json_file_dir,image_dir=args.val_image_dir)
        dataset_val.prepare()
