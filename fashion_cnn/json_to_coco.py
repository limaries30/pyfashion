...
if __name__=='__main__':
    ...
    parser.add_argument("--img_dir",
                        default='C:\\tensor_code\\fashion\\dataset\\deepfashion2\\train\\2',
                        help="'train' or 'evaluate' on MS COCO")
    parser.add_argument("--anno_dir",
                        default='C:\\tensor_code\\fashion\\dataset\\deepfashion2\\train\\train_anno_2',
                        help="'train' or 'evaluate' on MS COCO")
    parser.add_argument("--json_name",
                        default='C:\\tensor_code\\fashion\\dataset\\deepfashion2\\train\\coco_train_2.json',
                        help="'train' or 'evaluate' on MS COCO")
    ...
    start=int(img_files[0].name.split('.')[0])
    end=int(img_files[-1].name.split('.')[0])+1
