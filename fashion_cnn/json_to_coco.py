...
img_dir=pathlib.Path('C:\\tensor_code\\fashion\\dataset\\deepfashion2\\train\\1')
anno_dir=pathlib.Path('C:\\tensor_code\\fashion\\dataset\\deepfashion2\\train\\train_anno_1')

img_iter=img_dir.glob('*')
img_files=[i for i in img_iter]


sub_index = 0 # the index of ground truth instance
num_images =len(img_files)
start=num_images*1+1  #19176*1+1
end=start+num_images  #19176*1+1+19176
assert num_images==end-start
print('사진 갯수:',end-start)


for num in range(start,end):
    
    json_name = str(num).zfill(6)+'.json'
    image_name = str(num).zfill(6)+'.jpg'

    json_file_dir=anno_dir/json_name
    img_file_dir=img_dir/image_name
    ...
    if (num>=0):
        imag = Image.open(str(img_file_dir))
        width, height = imag.size
        with open(str(json_file_dir), 'r') as f:
            ...
            for i in temp:
                if i == 'source' or i=='pair_id':  #['item1','source','pair_id']인 경우도 있음!
                    continue
                else:
...
json_name = 'C:\\tensor_code\\fashion\\dataset\\deepfashion2\\train\\deepfashion2_train_2.json'
